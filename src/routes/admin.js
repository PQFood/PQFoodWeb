...
router.get('/deleteShipPay/:slug', admincontroller.deleteShipPay);
router.get('/deleteOrderPay/:slug', admincontroller.deleteOrderPay);
router.get('/deleteCurrentShip/:slug', admincontroller.deleteCurrentShip);
